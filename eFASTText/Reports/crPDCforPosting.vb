...
Public Class crPDCforPosting
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "eFastText.crPDCforPosting.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_PostedBy() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedcrPDCforPosting
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crPDCforPosting = New crPDCforPosting
        rpt.Site = Me.Site
        Return rpt
    End Function
