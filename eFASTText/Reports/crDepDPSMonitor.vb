...
Public Class crDepDPSMonitor
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "eFastText.crDepDPSMonitor.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrDepDPSMonitor
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crDepDPSMonitor = New crDepDPSMonitor
        rpt.Site = Me.Site
        Return rpt
    End Function
