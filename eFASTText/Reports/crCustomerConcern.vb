...
Public Class crCustomerConcern
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "eFastText.crCustomerConcern.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_txtFiltered() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedcrCustomerConcern
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crCustomerConcern = New crCustomerConcern
        rpt.Site = Me.Site
        Return rpt
    End Function
